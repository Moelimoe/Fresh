...
class GoodsSKU(BaseModel):
    ...
    kind = models.ForeignKey("goods.GoodsKind", verbose_name="商品种类", on_delete=models.CASCADE)
    spuID = models.ForeignKey("goods.GoodsSPU", verbose_name="spuID", on_delete=models.CASCADE)
...
class GoodsImage(BaseModel):
    ...
    skuID = models.ForeignKey("goods.GoodsSKU", verbose_name="商品skuID", on_delete=models.CASCADE)
...
class PromotionList(BaseModel):
    ...
    act_name = models.CharField(verbose_name="活动名称", max_length=20)
